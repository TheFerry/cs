...
const std::unordered_map<std::string, IconInfo> iconSet = {
    ...
    {"url", {"󱃿", {66, 165, 245}}},               // url
    {"console", {"󰆍", {250, 111, 66}}},           // console
    {"word", {"\ue6a5", {1, 87, 155}}},              // word
    {"certificate", {"\uf2c3", {249, 89, 63}}},      // certificate
    {"key", {"󰌋", {48, 166, 154}}},               // key
    {"font", {"\uf031", {244, 68, 62}}},             // font
    {"lib", {"\ueb9c", {139, 195, 74}}},             // lib
    {"ruby", {"\ue739", {229, 61, 58}}},             // ruby
    ...
    {"powerpoint", {"󰈨", {209, 71, 51}}},         // powerpoint
    {"video", {"󰕧", {253, 154, 62}}},             // video
    {"virtual", {"\uf109", {3, 155, 229}}},          // virtual
    {"email", {"󰇮", {66, 165, 245}}},             // email
    {"audio", {"\ufb75", {239, 83, 80}}},            // audio
    {"coffee", {"\uf0f4", {66, 165, 245}}},          // coffee
    {"document", {"󰈙", {66, 165, 245}}},          // document
    ...
    {"cake", {"󰃫", {250, 111, 66}}},              // cake
    {"nim", {"󰆥", {255, 202, 61}}},               // nim
    ...
    {"npm", {"\ue71e", {203, 56, 55}}},              // npm
    {"yarn", {"󰄛", {44, 142, 187}}},            // yarn
    {"android", {"\uf531", {139, 195, 74}}},         // android
    {"tune", {"\ufb69", {251, 193, 60}}},            // tune
    {"contributing", {"󰅍", {255, 202, 61}}},    // contributing
    {"readme", {"󰋽", {66, 165, 245}}},            // readme
    {"changelog", {"\ufba6", {139, 195, 74}}},       // changelog
    {"credits", {"󰉠", {156, 204, 101}}},          // credits
    ...
    {"conduct", {"󰅎", {205, 220, 57}}},         // conduct
    {"jenkins", {"\ue767", {240, 214, 183}}},        // jenkins
    {"code-climate", {"󰔉", {238, 238, 238}}},     // code-climate
    {"log", {"󱔗", {175, 180, 43}}},               // log
    {"ejs", {"\ue618", {255, 202, 61}}},             // ejs
    ...
    {"vala", {"󰊬", {149, 117, 205}}}, // vala (Not supported by nerdFont)
    ...
    {"tex", {"󰊄", {66, 165, 245}}}, // tex (Not supported by nerdFont)
    {"graphql",
    ...
    {"puppet", {"󰂖", {251, 193, 60}}}, // puppet (Not supported by nerdFont)
    {"purescript",
     {"󰅱", {66, 165, 245}}}, // purescript (Not supported by nerdFont)
    {"merlin",
    ...
    {"babel", {"󰂡", {253, 217, 59}}},  // babel (Not supported by nerdFont)
    {"codecov",
    ...
    {"mocha", {"󰆪", {161, 136, 127}}}, // mocha (Not supported by nerdFont)
    {"firebase",
    ...
    {"i18n", {"󰊿", {121, 134, 203}}},  // i18n (Not supported by nerdFont)
    {"semantic-release",
     {"󰈐", {245, 245, 245}}}, // semantic-release (Not supported by nerdFont)
    ...
    {"gcp", {"󰅣", {70, 136, 250}}},     // gcp (Not supported by nerdFont)
    ...
    {"dir-include", {"󰉗", {3, 155, 229}}},       // dir-include
    {"dir-import", {"󰉗", {175, 180, 43}}},       // dir-import
    {"dir-upload", {"󰉙", {250, 111, 66}}},       // dir-upload
    {"dir-download", {"󰉍", {76, 175, 80}}},      // dir-download
    {"dir-secure", {"󰉐", {249, 169, 60}}},       // dir-secure
    {"dir-images", {"󰉏", {43, 150, 137}}},       // dir-images
    {"dir-environment", {"󰉏", {102, 187, 106}}}, // dir-environment
